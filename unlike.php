...
// unlike
mysql_query("DELETE FROM `like` WHERE `id_user` = '".$f['id_user']."' AND `id_photo` =  '".$id_photo."'");


//mysql_query("UPDATE photo SET `like`= `like`+1 WHERE id_photo=".$_GET['id']) or die(mysql_error());
?>
